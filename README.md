...
## Project Structure
    ...
    ├── ocd_schedule_assist_33647  # Django project configurations
...
1. Clone this repo and `cd ocd_schedule_assist_33647`
...
2. Clone this repo and `cd ocd_schedule_assist_33647`
